...
namespace database_relation
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet.內容簡介' table. You can move, or remove it, as needed.
            this.內容簡介TableAdapter.Fill(this.database1DataSet.內容簡介);
